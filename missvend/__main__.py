...
from missvend import dispatcher, updater, TOKEN, WEBHOOK, SUDO_USERS, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, OWNER_NAME, ALLOW_EXCL, telethn
from missvend.modules import ALL_MODULES
from missvend.modules.helper_funcs.chat_status import is_user_admin
from missvend.modules.helper_funcs.misc import paginate_modules
from missvend.modules.connection import connected
from missvend.modules.connection import connect_button
...
SOURCE_STRING = """
⚡I'm built in python3, using the python-telegram-bot library, and am fully opensource - you can find what makes me tick [here](https://github.com/Sur-vivor/MissvendProBot)
⚡You Can Clone Me [Here](https://heroku.com/deploy?template=https://github.com/Sur-vivor/MissvendProBot.git)
"""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("missvend.modules." + module_name)
