...
def get_user_list(config, key):
    with open('{}/missvend/{}'.format(os.getcwd(), config), 'r') as json_file:
...
class Config(object):
    ...
    # RECOMMENDED
    SQLALCHEMY_DATABASE_URI = 'postgres://yzwgsujuwuyttn:679bd9c13e143767db9bbb85e58fd5992320e15b7808d9617d7eb949b9f1f657@ec2-52-72-155-37.compute-1.amazonaws.com:5432/d5s5asrar6ftra'  # needed for any database modules
