...
if ENV:
    ...
    from missvend.config import Development as Config
...
telethn = TelegramClient("missvend", api_id, api_hash)
...
from missvend.modules.helper_funcs.handlers import CustomCommandHandler, CustomRegexHandler, CustomMessageHandler
